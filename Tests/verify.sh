...
test -f "$TEST_APP/Contents/Resources/Scripts/meeting_triage.py"
test -f "$TEST_APP/Contents/Resources/Scripts/trash_cleanup.py"
test -f "$TEST_APP/Contents/Resources/Scripts/obsidian_publish.py"
test -x "$TEST_APP/Contents/Resources/Scripts/mtg"
test -f "$TEST_APP/Contents/Resources/Scripts/mtg_index.py"
test -x "$TEST_APP/Contents/Resources/Scripts/migrate_runs.py"
test -x "$TEST_APP/Contents/Resources/Scripts/triage_runs.py"
test -f "$TEST_APP/Contents/Resources/Scripts/triage_result.schema.json"
...
python3 "$ROOT/Tests/test_trash_cleanup.py"
python3 "$ROOT/Tests/test_obsidian_publish.py"
python3 "$ROOT/Tests/test_postprocess_followups.py"
python3 "$ROOT/Tests/test_mtg_cli.py"
python3 "$ROOT/Tests/test_migrate_runs.py"
python3 "$ROOT/Tests/test_triage_runs.py"
